...
class FileManager:
    ...
    def save_results(self, summary_data: dict, scraped_data: dict, processed_data: dict) -> dict:
        """
    ...
    def _create_result_data(
        self, summary_data: dict, scraped_data: dict, processed_data: dict
    ) -> dict:
        """Create comprehensive result data structure"""

        # Calculate processing statistics
        processing_stats = self._calculate_processing_stats(
            scraped_data, processed_data, summary_data
        )
        ...
        result_data = {
            "metadata": {
                ...
                "scraped_at": datetime.fromtimestamp(scraped_data.get("scraped_at", 0)).isoformat()
    ...
    def _calculate_processing_stats(
        self, scraped_data: dict, processed_data: dict, summary_data: dict
    ) -> dict:
    ...
    def _calculate_summary_stats(self, result_data: dict) -> dict:
        ...
        return {
            "words_original": result_data.get("statistics", {})
            .get("original", {})
            .get("word_count", 0),
    ...
    def load_cached_result(self, url: str) -> dict | None:
